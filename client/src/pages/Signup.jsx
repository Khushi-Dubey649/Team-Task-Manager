...
import { Mail, Lock, ArrowRight, CheckSquare, Loader2, User } from 'lucide-react';
...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // NOTE: Uncomment when backend is running
            // const response = await api.post('/auth/signup', { name, email, password });
            // login(response.data.data.user, response.data.token);
            
            // Mock Signup for Demo
            setTimeout(() => {
                login({ id: '2', name, email, role: 'Admin' }, 'mock_jwt_token_123');
                navigate('/dashboard');
            }, 800);
        } catch (err) {
            ...
            <div className="w-full max-w-md relative z-10 px-4">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white p-8 sm:p-10 transition-all">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-slate-500 mt-2 text-sm text-center">Join TaskMaster and manage your projects</p>
                    </div>
